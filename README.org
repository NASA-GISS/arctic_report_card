...
Data variables:
    ...
    MB_HIRHAM  float32 -46.43
    MB_MAR     float32 -145.1
    MB_RACMO   float32 0.0
#+end_example

SMB from GRACE
+ [ ] -291 + 507 + 23 = 239 # hydro year, see above.
+ [ ] -145 + 507 + 23 = 385 # GRACE period using MAR SMB
+ [ ] -47 + 507 + 23 = 483 # HIRHAM rather than MAR

+ [ ] GRACE MB (from Google Doc) = -90
+ [ ] MB = SMB - D - BMB => SMB = MB + D + BMB => -90*0.84 + 504 + 23 = 451.4
